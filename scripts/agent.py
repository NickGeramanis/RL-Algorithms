...
def main():
    ...
    tabular_monte_carlo = TabularMonteCarlo(env, discount_factor,
                                            discretizer)
    tabular_monte_carlo.train(n_episodes)

    tabular_sarsa = TabularSARSA(env,
                                 discount_factor,
    ...
    tabular_sarsa_lambda = TabularSARSALambda(env,
                                              discount_factor,
                                              initial_learning_rate,
                                              learning_rate_midpoint,
                                              learning_rate_steepness,
    ...
    tabular_q_lambda = TabularQLambda(env,
                                      discount_factor,
                                      initial_learning_rate,
                                      learning_rate_midpoint,
                                      learning_rate_steepness,
    ...
    order = 2
    feature_constructor3 = FourierBasis(env.action_space.n,
                                        order,
                                        state_space_low,
                                        state_space_high)
    ...
    lfa_q_learning = LFAQLearning(env,
                                  discount_factor,
                                  initial_learning_rate,
                                  learning_rate_midpoint,
                                  learning_rate_steepness,
    ...
    lfa_sarsa_lambda = LFASARSALambda(env,
                                      ...
                                      learning_rate_midpoint,
                                      learning_rate_steepness,
                                      feature_constructor3,
                                      lambda_)
    lfa_sarsa_lambda.train(n_episodes)

    lfa_q_lambda = LFAQLambda(env,
                              discount_factor,
                              initial_learning_rate,
                              learning_rate_midpoint,
                              learning_rate_steepness,
                              feature_constructor4,
                              lambda_)
